...
%   W_m = [lambda/(lambda+3); 1/(2*(3+lambda)); 1/(2*(3+lambda)); 1/(2*(3+lambda)); 1/(2*(3+lambda)); 1/(2*(3+lambda)); 1/(2*(3+lambda))];
  ...
  W_c = [W0; (1-W0)/(2*N_x); (1-W0)/(2*N_x); (1-W0)/(2*N_x); (1-W0)/(2*N_x); (1-W0)/(2*N_x); (1-W0)/(2*N_x);(1-W0)/(2*N_x);(1-W0)/(2*N_x)];
  W_m = [W0; (1-W0)/(2*N_x); (1-W0)/(2*N_x); (1-W0)/(2*N_x); (1-W0)/(2*N_x); (1-W0)/(2*N_x); (1-W0)/(2*N_x);(1-W0)/(2*N_x);(1-W0)/(2*N_x)];%change the w0 to 1/3
